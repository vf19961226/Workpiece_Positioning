...
right_bottom = [img.shape[1] -240, img.shape[0]/2 -80]
left_top = [img.shape[1]/2 +5 , img.shape[0]*0 +80]
right_top = [img.shape[1] -240, img.shape[0]*0 +80]
mid_left_bottom = [img.shape[1]/2 +5, img.shape[0]*0 +105]
mid = [img.shape[1]/2 +55, img.shape[0]*0 +105]
mid_right_bottom = [img.shape[1]/2 +55, img.shape[0]/2 -80]
