# -*- coding: utf-8 -*-
"""
Created on Fri May 28 21:13:24 2021
...
[2] https://www.rs-online.com/designspark/nvidia-jetson-nanotensor-rtyolov4-1-cn
"""
...
try:
    ctypes.cdll.LoadLibrary('./data/plugins/libyolo_layer.so')
except OSError as e:
    raise SystemExit('ERROR: failed to load ./data/plugins/libyolo_layer.so.  ') from e
